...
class PressureCalc():
    ...
    def pressureDropCalc(self,variable1,variable2, **sysParam):
            """
            Calculates the pressure drop of a pneumatic conveying system

            Parameters
            ----------
            variable1 : str
                Simulate pressure drop for this variable
            variable2 : str
                Simulate pressure drop for this variable
            ...
            vary1 = sysParam[variable1][1]
            vary2 = sysParam[variable2][1]

            for i in vary1:
                tempList = []
                for j in vary2:
                    sysParam[variable1] = (sysParam[variable1][0],i)
                    sysParam[variable2] = (sysParam[variable2][0],j)
                    ...
                    rho_air = (sysParam['pres'][1]/(sysParam['R'][1]*1000*sysParam['T'][1])+1.89)/2  # kg/m3 Average density
                    Vfa = sysParam['Mfa'][1]/(rho_air)  # Average volumetric flow rate air
                    va = Vfa/Ac  # Average velocity air
                    slr = sysParam['Mfs'][1]/sysParam['Mfa'][1]  # Solids loading ratio
